    ...
    begin
        ...
        select etl.sq_input_file.nextval,
            ...
            p_start_dt  as SNAPSHOT_DT,
                    sysdate as START_DT,
                    sysdate as END_DT,
                'Создание записи: maintenence_cost_rates='||p_MAINTENENCE_COST_RATES||' start_dt='||p_start_dt as STATUS_DESC,
            '1' as STATUS_CD,
            null as FILE_NAME,
...
begin
    ...
    forall i in 1..v_rowids.count
        insert into DWH.MAINTENENCE_COST_RATES(MAINTENENCE_COST_RATE, START_DT, END_DT, VALID_FROM_DTTM, VALID_TO_DTTM, USERNAME)
        select MAINTENENCE_COST_RATE, START_DT, p_start_dt - 1, v_now_d, GC_EOW_D, v_user
