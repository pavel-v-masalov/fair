drop table DWH.LEASROUT_TASKNEW_10009KUF_TMP;
...
where t.new_status = 100000002 and t.statecode = 1 and t.new_type = 100000009
  and (t.SUBJECT like '%ÊÓÔÐ%' and t.SUBJECT like '%Îäîáðåíèå%') and VALID_TO_DTTM = to_date('2400-01-01', 'yyyy-mm-dd')
) t;

create index DWH.LEASROUT_TASK_10009KUF_TMP_i01 on DWH.LEASROUT_TASKNEW_10009KUF_TMP(opportunityid, COUNTEDON, rn) compress 2;
