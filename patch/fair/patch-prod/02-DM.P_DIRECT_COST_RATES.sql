...
begin
    ...
    forall i in 1..v_rowids.count
        insert into DWH.DIRECT_COST_RATES(DIRECT_COST_RATE, START_DT, END_DT, VALID_FROM_DTTM, VALID_TO_DTTM, FILE_ID)
        select DIRECT_COST_RATE, START_DT, p_start_dt - 1, v_now_d, GC_EOW_D, FILE_ID
