...
create table DM.FAIR_VALUE (
  ...
  FORMULATION_IND_CNCL_KEY NUMBER,
...
COMMENT ON COLUMN DM.FAIR_VALUE.FEDERAL_LOW_TYPE_KEY is 'Ключ Сделки в рамках (ФЗ)';
...
COMMENT ON COLUMN DM.FAIR_VALUE.FORMULATION_IND_CNCL_KEY is 'Ключ Формулировки отмены индикаторов';
